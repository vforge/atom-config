...
function requestData(provider, args, thisObj, timeout) {
    ...
    if (typeof provider === "function") {
        ...
        if (value !== undefined) {
            asyncValue.bC_(value);
        }
    } else {
        // Assume the provider is a data object...
        asyncValue.bC_(provider);
    }
    ...
    if (timeout > 0) {
        let timeoutId = setTimeout(function () {
            ...
            asyncValue.bB_(error);
        }, timeout);

        asyncValue.bA_(function () {
            if (timeoutId != null) {
...
module.exports = function awaitTag(input, out) {
    ...
    if (clientReorder) {
        ...
        clientReorderContext = out.global.bD_ || (out.global.bD_ = {
            instances: [],
            nextId: 0
        });
