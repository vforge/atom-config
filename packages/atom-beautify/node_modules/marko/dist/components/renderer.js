...
function resolveComponentKey(globalComponentsContext, key, ownerComponentDef, parentComponentDef) {
    if (key[0] === "#") {
        return key.substring(1);
    } else {
        parentComponentDef = parentComponentDef || ownerComponentDef;
        return parentComponentDef._h_(ownerComponentDef.id + "-" + key);
    }
}
    ...
    return function renderer(input, out) {
        ...
        if (component) {
            ...
            if (ownerComponentDef) {
                ...
                if (key != null) {
                    id = resolveComponentKey(globalComponentsContext, key.toString(), ownerComponentDef, parentComponentDef);
                } else {
                    id = ownerComponentDef._k_();
                }
            } else {
        ...
        var componentDef = beginComponent(componentsContext, component, isSplit, ownerComponentDef, isImplicitComponent);
