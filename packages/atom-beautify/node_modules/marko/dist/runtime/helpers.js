    ...
    d: function dynamicTag(tag, attrs, out, componentDef, key, customEvents) {
        if (tag) {
            if (typeof tag === "string") {
                ...
                var events = customEvents && customEvents.reduce((events, eventArray) => {
                    events["on" + eventArray[0]] = componentDef.d(eventArray[1], eventArray[2], eventArray[3]);
                    return events;
                }, {});
                if (attrs.renderBody) {
                    ...
                    out.aD_(tag, otherAttrs, key, component, 0, 0, events);
                    renderBody(out);
                    out.aE_();
                } else {
                    out.aF_(tag, attrs, key, component, 0, 0, events);
                }
                ...
                if (isFn || isToken) {
                    var flags = componentDef ? componentDef._e_ : 0;
