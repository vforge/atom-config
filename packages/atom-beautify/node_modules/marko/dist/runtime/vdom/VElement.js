...
function VElement(tagName, attrs, key, component, childCount, flags, props) {
    ...
    this.aw_ = key;
    this._a_ = component;
    this.bn_ = attrs || EMPTY_OBJECT;
    this.aj_ = props || EMPTY_OBJECT;
    this.bo_ = namespaceURI;
    this.ap_ = tagName;
    this.bp_ = null;
    this.ay_ = constId;
    this.bq_ = isTextArea;
...
VElement.prototype = {
    ...
    e: function (tagName, attrs, key, component, childCount, flags, props) {
        var child = this.ba_(new VElement(tagName, attrs, key, component, childCount, flags, props));
    ...
    ed: function (tagName, attrs, key, component, childCount, flags, props) {
        var child = this.ba_(VElement.bb_(tagName, attrs, key, component, childCount, flags, props));
    ...
    aq_: function (doc) {
        var namespaceURI = this.bo_;
        var tagName = this.ap_;

        var attributes = this.bn_;
        var flags = this._e_;
...
defineProperty(proto, "az_", {
    get: function () {
        var value = this.bp_;
        if (value == null) {
            value = this.bn_.value;
        }
        return value != null ? toString(value) : "";
    }
});

VElement.bb_ = function (tagName, attrs, key, component, childCount, flags, props) {
    ...
    element.bo_ = namespace;
    return element;
};

VElement.bs_ = function (attrs) {
...
function virtualizeElement(node, virtualizeChildNodes) {
    ...
    if (node.namespaceURI !== "http://www.w3.org/1999/xhtml") {
        vdomEl.bo_ = node.namespaceURI;
    }

    if (vdomEl.bq_) {
        vdomEl.bp_ = node.value;
    } else {
...
VElement.ao_ = function (fromEl, vFromEl, toEl) {
    var removePreservedAttributes = VElement.bs_;
