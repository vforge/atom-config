...
<html lang="en">
<head>
    <title>Code coverage report for lib/repo-worker-proxy.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">lib</a> repo-worker-proxy.js
    </h1>
    <div class='clearfix'>
...
51
52
53</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const Emitter = require('events')
...
&nbsp;
  constructor (path, config, workerPath) {
    ...
    this.on('config.update', <span class="fstat-no" title="function not covered" >co</span>nfig =&gt; <span class="cstat-no" title="statement not covered" >this.config = config)</span>
