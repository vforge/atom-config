...
export default class AutoLanguageClient {
    ...
    protected getConnectionForEditor(editor: TextEditor): Promise<ls.LanguageClientConnection | null>;
    ...
    private startExclusiveAdapters(server);
    ...
    protected onDidConvertAutocomplete(completionItem: ls.CompletionItem, suggestion: AutocompleteSuggestion, request: AutocompleteRequest): void;
     ...
     */
    private handleServerStderr(stderr, projectPath);
}
