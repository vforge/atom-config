...
ava_1.default('minimal parsed query', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                */
                _b = (_a = t).deepEqual;
                return [4 /*yield*/, index_1.request('https://api.graph.cool/simple/v1/movies', graphql_tag_1.default(templateObject_1 || (templateObject_1 = __makeTemplateObject(["query { Actor(name: \"Tom Hardy\") { name } }"], ["query { Actor(name: \"Tom Hardy\") { name } }"]))))];
            case 1:
                /*
                This test is flaky because it relies on the internet
                but the mock passed for this feature (parsed query) without
