...
var GraphQLClient = /** @class */ (function () {
    ...
    GraphQLClient.prototype.request = function (query, variables) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, headers, others, printedQuery, body, response, result, errorResult;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.options, headers = _a.headers, others = __rest(_a, ["headers"]);
                        printedQuery = typeof query === 'object' ? graphql_1.print(query) : query;
                        body = JSON.stringify({
                            query: printedQuery,
                            variables: variables ? variables : undefined,
                        });
                    ...
                    case 2:
                        ...
                        if (response.ok && !result.errors && result.data) {
                            ...
                            errorResult = typeof result === 'string' ? { error: result } : result;
                            throw new types_1.ClientError(__assign({}, errorResult, { status: response.status }), { query: printedQuery, variables: variables });
                        }
                        return [2 /*return*/];
                }
            });
