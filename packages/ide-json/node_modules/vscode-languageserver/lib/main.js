...
function _createConnection(input, output, strategy, factories) {
    if (!input && !output && process.argv.length > 2) {
        ...
        if (port) {
            ...
            let protocol = vscode_languageserver_protocol_1.createServerPipeTransport(pipeName);
            input = protocol[0];
            output = protocol[1];
        }
    }
...
(function (ProposedFeatures) {
    ...
    ProposedFeatures.all = {
        __brand: 'features',
        workspace: combineWorkspaceFeatures(ProposedFeatures.WorkspaceFoldersFeature, ProposedFeatures.ConfigurationFeature)
    };
