...
let getFlowVersionInfo = (() => {
  var _ref3 = (0, _asyncToGenerator2.default)(function* (rootPath, connection, flowOptions) {
    ...
    if (flowOptions.flowPath != null) {
      ...
      const flowVersionInfo = yield _flowVersions.utils.versionInfoForPath(rootPath, flowOptions.flowPath);
    ...
    const versionInfo = yield (0, _flowVersions.flowBinForRoot)(rootPath, {
      autoDownloadFlow: flowOptions.autoDownloadFlow,
      reporter: downloadManagerLogger,
      semverDownloader: _flowVersions.githubSemverDownloader,
...
var _DocumentHighlight = require('./DocumentHighlight');

var _DocumentHighlight2 = _interopRequireDefault(_DocumentHighlight);
...
var _FileCache = require('./pkg/nuclide-open-files-rpc/lib/FileCache');
...
var _flowVersions = require('flow-versions');
...
function createServer(connection, initialFlowOptions) {
  ...
  const fileCache = new _FileCache.FileCache();
  ...
  connection.onInitialize((() => {
    var _ref = (0, _asyncToGenerator2.default)(function* ({ capabilities, rootPath }) {
      ...
      const flow = new _FlowSingleProjectLanguageService.FlowSingleProjectLanguageService(root, flowContainer, fileCache);
      ...
      const documentHighlight = new _DocumentHighlight2.default({ documents, flow });
      connection.onDocumentHighlight(function (docParams) {
