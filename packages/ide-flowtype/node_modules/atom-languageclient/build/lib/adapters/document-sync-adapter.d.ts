...
export default class DocumentSyncAdapter {
    ...
    constructor(connection: LanguageClientConnection, editorSelector: (editor: TextEditor) => boolean, documentSync?: TextDocumentSyncOptions | TextDocumentSyncKind);
    dispose(): void;
...
export declare class TextEditorSyncAdapter {
    ...
    constructor(editor: TextEditor, connection: LanguageClientConnection, documentSync: TextDocumentSyncOptions, versions: Map<string, number>);
