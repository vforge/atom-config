...
let schemaRequestService = (uri) => {
    ...
    if (Strings.startsWith(uri, 'file://')) {
        ...
        let scheme = uri_1.default.parse(uri).scheme.toLowerCase();
...
exports.customLanguageService = yamlLanguageService_1.getLanguageService(schemaRequestService, workspaceContext, [], (resource) => connection.sendRequest(CustomSchemaRequest.type, resource));
