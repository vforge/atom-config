...
export declare function doComplete(document: any, position: Position, syntax: string, emmetConfig: EmmetConfiguration): CompletionList;
 ...
 */
export declare function extractAbbreviation(document: any, position: Position, lookAhead?: boolean): {
 ...
 * @param textToReplace
 */
export declare function getExpandOptions(syntax: string, emmetConfig?: object, filter?: string): {
 ...
 * @param options
 */
export declare function expandAbbreviation(abbreviation: string, options: any): string;
/**
