...
function analyze$1(ast, parserOptions) {
...
function analyzeExternalReferences(ast, parserOptions) {
    const scope = analyze$1(ast, parserOptions);
...
function postprocess(ast, locationCalculator) {
...
function parseVOnExpression(code, locationCalculator, parserOptions) {
    ...
    try {
        ...
        const first$$1 = lodash.first(body);
        const last$$1 = lodash.last(body);
        const expression = {
            type: "VOnExpression",
            range: [
                (first$$1 != null) ? first$$1.range[0] : block.range[0] + 1,
                (last$$1 != null) ? last$$1.range[1] : block.range[1] - 1,
            ],
            loc: {
                start: (first$$1 != null) ? first$$1.loc.start : locationCalculator.getLocation(1),
                end: (last$$1 != null) ? last$$1.loc.end : locationCalculator.getLocation(code.length + 1),
            },
            parent: DUMMY_PARENT$1,
            body,
        };
...
function parseAttributeValue(code, parserOptions, globalLocationCalculator, node, directiveName) {
    ...
    const result = (directiveName === "for" ? parseVForExpression(node.value, locationCalculator, parserOptions) :
...
class Parser {
    ...
    EndTag(token) {
        ...
        const i = lodash.findLastIndex(this.elementStack, (el) => el.name.toLowerCase() === token.name);
        if (i === -1) {
