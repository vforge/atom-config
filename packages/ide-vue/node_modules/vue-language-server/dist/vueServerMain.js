...
(function (ColorSymbolRequest) {
    ColorSymbolRequest.type = new vscode_languageserver_1.RequestType('vue/colorSymbols');
...
connection.onDocumentOnTypeFormatting(onTypeFormatParams => {
    ...
    const startPos = vscode_languageserver_types_1.Position.create(endPos.line - (isNewLine ? 1 : 0), 1);
    const range = vscode_languageserver_types_1.Range.create(startPos, endPos);
