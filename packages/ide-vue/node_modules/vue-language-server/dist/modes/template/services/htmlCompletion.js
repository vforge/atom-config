        ...
        while (curr) {
            ...
            if (tag && (!curr.closed || curr.endTagStart > offset)) {
                ...
                if (startIndent !== null && endIndent !== null && startIndent !== endIndent) {
                    ...
                    (item.textEdit = vscode_languageserver_types_1.TextEdit.replace(getReplaceRange(afterOpenBracket - 1 - endIndent.length), insertText)), (item.filterText = endIndent + '</' + tag + closeTag);
                }
