...
const u = undefined;
const routerTags = {
    'router-link': new common_1.HTMLTagSpecification('Link to navigate user. The target location is specified with the to prop.', [common_1.genAttribute('to', u, 'The target route of the link. It can be either a string or a location descriptor object.'),
