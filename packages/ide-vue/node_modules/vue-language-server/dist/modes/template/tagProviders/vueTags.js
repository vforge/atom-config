...
const vueDirectives = [
    ...
    common_1.genAttribute('v-cloak', 'v', 'Indicates Vue instannce on the element has NOT finishes compilation.'),
...
const vueTags = {
    component: new common_1.HTMLTagSpecification('A meta component for rendering dynamic components. The actual component to render is determined by the `is` prop.', [common_1.genAttribute('is', u, 'the actual component to render'),
    ...
    template: new common_1.HTMLTagSpecification('The template element is used to declare fragments of HTML that can be cloned and inserted in the document by script.', [common_1.genAttribute('scope', u, 'the name of a temporary variable that holds the props object passed from the child'),
