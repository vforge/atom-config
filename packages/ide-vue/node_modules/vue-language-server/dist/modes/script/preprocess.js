...
function createUpdater() {
    ...
    return {
        createLanguageServiceSourceFile(fileName, scriptSnapshot, scriptTarget, version, setNodeParents, scriptKind) {
            ...
            const hackSourceFile = sourceFile;
...
function modifyVueSource(sourceFile) {
    ...
    if (exportDefaultObject) {
        ...
        const vueImport = setZeroPos(ts.createImportDeclaration(undefined, undefined, setZeroPos(ts.createImportClause(ts.createIdentifier('__vueEditorBridge'), undefined)), // TODO: remove this after 2.4
