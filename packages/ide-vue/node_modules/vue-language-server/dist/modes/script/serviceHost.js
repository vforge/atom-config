...
function getServiceHost(workspacePath, jsDocuments) {
    ...
    const parsedConfig = ts.parseJsonConfigFileContent(configJson, ts.sys, workspacePath, {}, configFilename, undefined, [{ extension: 'vue', isMixedContent: true }]);
    const files = parsedConfig.fileNames;
    const isOldVersion = inferIsOldVersion(workspacePath);
    compilerOptions = Object.assign({}, compilerOptions, parsedConfig.options);
